...
public class MyPatientsAdapterChat extends RecyclerView.Adapter<MyPatientsAdapterChat.ViewHolder> {
    ...
    public MyPatientsAdapterChat(Context mContext, List<UserModel> mUsers, boolean ischat) {
        this.mUsers = mUsers;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.listitem_mypatientschat, parent, false);
        return new MyPatientsAdapterChat.ViewHolder(view);
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View itemView) {
            super(itemView);
            name = itemView.findViewById(R.id.mypatientschat_name);
            username = itemView.findViewById(R.id.mypatientschat_email);
            profile_image = itemView.findViewById(R.id.mypatientschat_prof);

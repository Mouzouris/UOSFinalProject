package com.example.myapplication.RecyclerViewItems
...
class ImageMessageItem(val message: ImageMessage,
    ...
    override fun bind(viewHolder: ViewHolder, position: Int) {
        ...
        Glide.with(context).load(StorageUtil.pathToReference(message.imagePath)).placeholder(R.drawable.ic_image_black_24dp).into(viewHolder.imageView_message_image)
    }
